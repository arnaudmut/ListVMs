...
RequiredModules = @(
   @{"ModuleName"="VMware.VimAutomation.Core";"ModuleVersion"="11.3.0.13964826"}
)
...
CmdletsToExport = @('Add-KeyManagementServer','Copy-VDisk','Export-SpbmStoragePolicy','Get-KeyManagementServer','Get-KmipClientCertificate','Get-KmsCluster','Get-NfsUser','Get-SpbmCapability','Get-SpbmCompatibleStorage','Get-SpbmEntityConfiguration','Get-SpbmFaultDomain','Get-SpbmPointInTimeReplica','Get-SpbmReplicationGroup','Get-SpbmReplicationPair','Get-SpbmStoragePolicy','Get-SpbmView','Get-VAIOFilter','Get-VasaProvider','Get-VasaStorageArray','Get-VDisk','Get-VsanClusterConfiguration','Get-VsanComponent','Get-VsanDisk','Get-VsanDiskGroup','Get-VsanEvacuationPlan','Get-VsanFaultDomain','Get-VsanIscsiInitiatorGroup','Get-VsanIscsiInitiatorGroupTargetAssociation','Get-VsanIscsiLun','Get-VsanIscsiTarget','Get-VsanObject','Get-VsanResyncingComponent','Get-VsanRuntimeInfo','Get-VsanSpaceUsage','Get-VsanStat','Get-VsanView','Import-SpbmStoragePolicy','Move-VDisk','New-KmipClientCertificate','New-NfsUser','New-SpbmRule','New-SpbmRuleSet','New-SpbmStoragePolicy','New-VAIOFilter','New-VasaProvider','New-VDisk','New-VsanDisk','New-VsanDiskGroup','New-VsanFaultDomain','New-VsanIscsiInitiatorGroup','New-VsanIscsiInitiatorGroupTargetAssociation','New-VsanIscsiLun','New-VsanIscsiTarget','Remove-KeyManagementServer','Remove-NfsUser','Remove-SpbmStoragePolicy','Remove-VAIOFilter','Remove-VasaProvider','Remove-VDisk','Remove-VsanDisk','Remove-VsanDiskGroup','Remove-VsanFaultDomain','Remove-VsanIscsiInitiatorGroup','Remove-VsanIscsiInitiatorGroupTargetAssociation','Remove-VsanIscsiLun','Remove-VsanIscsiTarget','Repair-VsanObject','Set-KeyManagementServer','Set-KmsCluster','Set-NfsUser','Set-SpbmEntityConfiguration','Set-SpbmStoragePolicy','Set-VAIOFilter','Set-VDisk','Set-VsanClusterConfiguration','Set-VsanFaultDomain','Set-VsanIscsiInitiatorGroup','Set-VsanIscsiLun','Set-VsanIscsiTarget','Start-SpbmReplicationFailover','Start-SpbmReplicationPrepareFailover','Start-SpbmReplicationPromote','Start-SpbmReplicationReverse','Start-SpbmReplicationTestFailover','Start-VsanClusterDiskUpdate','Start-VsanClusterRebalance','Start-VsanEncryptionConfiguration','Stop-SpbmReplicationTestFailover','Stop-VsanClusterRebalance','Sync-SpbmReplicationGroup','Test-VsanClusterHealth','Test-VsanNetworkPerformance','Test-VsanStoragePerformance','Test-VsanVMCreation','Update-VsanHclDatabase')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU3qqSxV7fDyXVCmQ4sdmzCwAi
# DlOgghhkMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# ARUwIwYJKoZIhvcNAQkEMRYEFEJBVLgCwPhThdjSO7fqhCt+ucQtMCoGCisGAQQB
# gjcCAQwxHDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wDQYJKoZIhvcNAQEB
# BQAEggEAl+f0fhOiC5pMPW2hOvTA/BALm3MC2ZA1SYn3wDTzljz4MX+6AnjAQn9O
# SBpITTjFubMTQC+OqByDRo5fk2LgZ2CZQ/J8o+z+Fk3Vp713orFjx4+jeq2nd7fg
# oWTKmSy9PNzWnAwbQBF5EQwcHacM5yI4giwpdSa5iJMEUn9j5ndG1ddOoUhrSKqE
# /LG7Bmko+6d2rY2eO9Ysf84T7tGlg2WDMOK8KxzpFbLknZXP6hio58bq2pYhwzt+
# mkptcuspRbN5e8FKk0DuR7Ec5IxsGzwIh6vhaQ82vjPavDsqjEMXRTW9nrcvVHMU
# LpDUdL933tAK+LYkNoChr+ib8MPSfKGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB
...
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xOTA2MTcwNzM3MjZaMCMG
# CSqGSIb3DQEJBDEWBBSnzmvUAuBsFBu/KbiGLFKhKhJ0XzANBgkqhkiG9w0BAQEF
# AASCAQCF7j/69MC5pqjo3w1QGDH7JnAor4NOK3egJk2V0uHtC/GuINZ1AmD6VbqN
# YJVtNr1LpDVBJhOyIatz2oN53EXCzyJh5t8sFB8A1heWQxZHWMvp2v2OEy4sogdS
# cDl6rD5lfIITV9xTCw8PLHfKZ0ai5/yUQbyRCf7Fsgmf5vanIcoudpE7PnQz/fp/
# zteRd8JXSNdagmbYpx/2B9YAZ+IKYnFOAJ0PzWoeWxfkEtPZfv/sSy/WtQwzjm9s
# oktqRgS8LnVSSVhVsdz5F65CdqNTVG4QVS6Dr51jJhZwtoUIdrzfjCoTN27u8H3v
# RowdKxELIOVpT6hqAsjxIfaAD375
