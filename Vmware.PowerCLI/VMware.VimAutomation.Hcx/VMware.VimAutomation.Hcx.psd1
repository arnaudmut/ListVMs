...
CmdletsToExport = @('Connect-HCXServer','Disconnect-HCXServer','Get-HCXAppliance','Get-HCXComputeProfile','Get-HCXContainer','Get-HCXDatastore','Get-HCXGateway','Get-HCXInterconnectStatus','Get-HCXInventoryCompute','Get-HCXInventoryDatastore','Get-HCXInventoryDVS','Get-HCXInventoryNetwork','Get-HCXJob','Get-HCXMigration','Get-HCXNetwork','Get-HCXNetworkBacking','Get-HCXNetworkExtension','Get-HCXNetworkProfile','Get-HCXReplication','Get-HCXReplicationSnapshot','Get-HCXService','Get-HCXServiceMesh','Get-HCXSite','Get-HCXSitePairing','Get-HCXStorageProfile','Get-HCXVM','New-HCXAppliance','New-HCXComputeProfile','New-HCXComputeProfileDVS','New-HCXComputeProfileNetwork','New-HCXMigration','New-HCXNetworkExtension','New-HCXNetworkMapping','New-HCXNetworkProfile','New-HCXReplication','New-HCXServiceMesh','New-HCXServiceMeshDVS','New-HCXSitePairing','New-HCXStaticRoute','Remove-HCXAppliance','Remove-HCXComputeProfile','Remove-HCXNetworkExtension','Remove-HCXNetworkProfile','Remove-HCXReplication','Remove-HCXServiceMesh','Remove-HCXSitePairing','Resume-HCXReplication','Set-HCXAppliance','Set-HCXComputeProfile','Set-HCXMigration','Set-HCXNetworkProfile','Set-HCXReplication','Set-HCXServiceMesh','Start-HCXMigration','Start-HCXReplication','Suspend-HCXReplication','Test-HCXMigration','Test-HCXReplication')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnZUsyPm5+h71XB62WF0O/9rD
# KQWgghhkMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# ARUwIwYJKoZIhvcNAQkEMRYEFJxgs5xr7S6t6xHcb8Bw34moqPxHMCoGCisGAQQB
# gjcCAQwxHDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wDQYJKoZIhvcNAQEB
# BQAEggEAPtPwDNpx6jElpx+YYTmmocHPGCUfNYKRjcJmGt75LAqytbzTHrn+U72q
# ifWEa+n22EvsF3zK3dnngH82um1VKn9D0yRaC1k3438dgTwxzyvWCgAZHcc86HYq
# s0+lqLK/sfQVLcOXtvKDRTFwWuATLv+FJUjr9163IueQ072/FLYPYUSF8v6tfqPK
# 1fzqcLjSt57VjmZn8aNPhebHOl3GR9+/fltzWV27RRP7HDrZAiX8hKO2INYaDlfx
# CwSImGei4/QFTQpliXKIAb3LuG7yRwHiryhDCnPDN4Z6nYxxXjaSecFlodaKltwG
# 60i8WWcoSGSiBk+xM83ityvzlyHtA6GCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB
...
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xOTA2MTcwODE4MzlaMCMG
# CSqGSIb3DQEJBDEWBBTVXZ7U81YlM84/q0PsWnFXXarYmTANBgkqhkiG9w0BAQEF
# AASCAQBd+oD5ZrJfQVXMz2QJ6AgV1Ibhy5nAVbz9buh6S/8EGY9v8TfMMx84d10N
# zAogT1joDG4qcwTJ/3YXEQmY3jAvS7Z++lGhGlOwc6qAjuRCxgqIq3fhe5r94YZy
# sBlbaAHzvY6JawS/4RSy6DUR75+dgPSFmPJKcYrzINLWMj2f87IpdXG+lHlJa2YF
# xMCKNSD0XNJBNnrqCRaRz8A79asL+2+UDaKM3fhBGHrXc4NV2fk/4WIhaPprjB98
# HLODLNsD7DDWuIWoYVAzjrnmSxEtifBrDqngZFo2jlQRkHKDKg21D0/JLbWK6K31
# UCp9ZqjziYNcMcrVaSzIvvLlEzZQ
